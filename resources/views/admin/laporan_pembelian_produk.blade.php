@extends('admin.main')
@section('judul')
<title>Admin | Laporan Pembelian Produk</title>
@endsection
@section('sidebar')
<!-- Sidebar Menu -->
<!-- Sidebar Menu -->
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/laporan_pembelian_perproduk" class="nav-link active">
                  <i class="far fa-dot-circle nav-icon"></i>
                ...
                <div class="card-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td>@currency($produk->harga_beli)</td>
                      <td> {{$produk->stok}}</td>
                      
                      <td>
                        <a href="/detail_pembelian_perproduk{{ $produk->id }}" class="btn mr-2 mb-2 btn-info"><i class="fa fa-search "></i></a>
                         </td>
