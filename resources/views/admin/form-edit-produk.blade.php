...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
        <a href="#" class="nav-link">
          <i class="nav-icon fas chart-bar"></i>
          <p>
            Laporan
            <i class="right fas fa-angle-left"></i>
          </p>
          ...
          <div class="col-12">
            <div class="card">
                <div class="modal-content">
                    ...
                    <form id="fileUploadForm" action="/ubahproduk{{ $produk_id->id }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="position-relative form-group"><label>Nama produk</label><input name="nama_produk" value="{{ $produk_id->nama_produk }}" type="text" class="form-control"  required>
                        ...
                        <div class="position-relative form-group"><label>Harga beli</label><input name="harga_beli" value="{{ $produk_id->harga_beli }}" type="number"  class="form-control"  required>
                            <div class="invalid-feedback">
                                    Masukkan harga beli !
                                </div>
                            </div>
                        <div class="position-relative form-group"><label>Harga jual</label><input name="harga_jual" value="{{ $produk_id->harga_jual }}" type="number"  class="form-control"  required>
                            <div class="invalid-feedback">
                                    Masukkan harga jual !
                                </div>
                            </div>
