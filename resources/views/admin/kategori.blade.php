                  ...
                  <table class="table">
                    ...
                    @foreach($kategori as $kategori)
                      <tr>
                        ...
                        <td>
                            <a href="/form-edit-kategori{{ $kategori->id }}" class="btn mr-2 mb-2 btn-warning"><i class="fa fa-edit ">Ubah</i></a>
                            <a href="#" data-id="{{ $kategori->id }}" data-nama="{{ $kategori->nama_kategori }}" class="btn mr-2 mb-2 btn-danger hapus_kategori"><i class="fa fa-delete ">Hapus</i></a>
                        </td>
                      </tr>
                      @php $no++ @endphp
                      @endforeach
  ...
  <div class="modal fade" id="form_kategori" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
			...
			<form action="/tambahkategori" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
            @csrf
                                            <div class="position-relative form-group"><label>Nama Kategori</label><input name="nama_kategori" type="text" class="form-control"  required>
...
<script>
 $(".hapus_kategori").click(function(){
    ...
    if (result.isConfirmed) {
      window.location = "/hapuskategori"+id_kategori+""
    }
    })
      });
</script>
